...
object MentionsDefaults {
    ...
    @Composable
    fun mentionTagColor(): Color = PaletteTheme.componentThemes.select.mentionTagColor

    @Composable
    fun highlightColor(): Color = PaletteTheme.componentThemes.select.mentionHighlightColor
}
