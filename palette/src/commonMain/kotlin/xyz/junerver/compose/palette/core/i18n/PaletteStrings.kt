...
data class PaletteStrings(
    ...
    val dateRangePickerPlaceholder: String,
    ...
    val markdownEditLabel: String,
    val markdownPreviewLabel: String,
    val markdownSplitLabel: String,
    ...
    companion object {
        fun zhCN(): PaletteStrings = PaletteStrings(
            ...
            dateRangePickerPlaceholder = "YYYY-MM-DD - YYYY-MM-DD",
