...
sealed class NavItem(
    ...
    data object Latex : NavItem("latex", "LaTeX", Icons.Default.Functions, ComponentCategory.DATA_DISPLAY)
    ...
    companion object {
        val all =
            listOf(
                ...
                InfiniteScroll, Backtop, Watermark, QRCode, Markdown, Mermaid, Latex, FloatButton,
