...
@Composable
@ReadOnlyComposable
private fun collapseDemoText(): CollapseDemoText = when (LocalLanguage.current) {
    Language.ZH_CN -> CollapseDemoText(
        title = "Collapse",
        subtitle = "折叠面板",
        basicSectionTitle = "基础用法",
        accordionSectionTitle = "手风琴模式",
        consistencyTitle = "Consistency 一致性",
        consistencyContent = "Consistent with real life: in line with the process and logic of real life, and comply with languages and habits that the users are used to.\n\n" +
            "Consistent within interface: all elements should be consistent, such as: design style, icons and texts, position of elements, etc.",
        feedbackTitle = "Feedback 反馈",
        feedbackContent = "Operation feedback: enable the users to clearly perceive their operations by style updates and interactive effects.\n\n" +
            "Visual feedback: reflect current state by updating or rearranging elements of the page.",
        efficiencyTitle = "Efficiency 效率",
        efficiencyContent = "Simplify the process: keep operating process simple and intuitive.\n\n" +
            "Definite and clear: enunciate your intentions clearly so that the users can quickly understand and make decisions.",
    )

    Language.EN_US -> CollapseDemoText(
        title = "Collapse",
        ...
        consistencyContent = "Consistent with real life: in line with the process and logic of real life, and comply with languages and habits that users are used to.\n\n" +
        ...
        feedbackContent = "Operation feedback: enable users to clearly perceive operations through style updates and interaction effects.\n\n" +
            "Visual feedback: reflect current state by updating or rearranging elements on the page.",
        efficiencyTitle = "Efficiency",
        efficiencyContent = "Simplify the process: keep the operation flow simple and intuitive.\n\n" +
